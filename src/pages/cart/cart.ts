...
class CartPage extends Page {
    ...
    renderCart() {
        ...
        rightTitle.innerText = CartPage.TextObj.rightTitle;
        leftTitle.innerText = CartPage.TextObj.leftTitle;
        productsNumText.innerText = CartPage.TextObj.productsNumText;
        productsPriceText.innerText = CartPage.TextObj.productsPriceText;
        productsNumTotal.innerText = sum.toString();
        productsPriceTotal.innerText = priceInCart.price.toString() + 'ʛ';
        promoText.innerText = CartPage.TextObj.promoText;
        buyBtn.innerText = CartPage.TextObj.buyBtn;
        productsPricePromo.innerHTML = '5G';
        appliedText.innerText = CartPage.TextObj.appliedText;
        appliedName.innerText = CartPage.TextObj.appliedName;
        appliedBtn.innerText = CartPage.TextObj.appliedBtn;
        foundName.innerText = CartPage.TextObj.appliedName;
        foundBtn.innerText = CartPage.TextObj.foundBtn;
        ...
        this.pageView.append(cartContainer);
        ...
        request.onload = function () {
            ...
            if (sum === 0) {
                ...
                leftContainer.innerText = CartPage.TextObj.emptyCart;
            } else {
            ...
            const order = new Order('div', 'order');
            order.renderOrder();
                        ...
                        downBtn.addEventListener('click', () => {
                            if (cart[key] > 0) {
                                ...
                                (cartPrice as HTMLDivElement).innerText =
                                    wandsData[arrId[i] - 1].price * arrNum[i] + 'ʛ';
